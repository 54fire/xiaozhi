...
#define TAG "CqjtC3WifiBoard"

LV_FONT_DECLARE(font_puhui_14_1);
LV_FONT_DECLARE(font_awesome_14_1);

class CqjtC3WifiBoard : public WifiBoard {
private:
...
public:
    CqjtC3WifiBoard() : boot_button_(BOOT_BUTTON_GPIO) {
...
public:
    PressToTalk() : Thing("PressToTalk", "控制对话模式，一种是长按对话，一种是单击后连续对话。") {
        ...
        properties_.AddBooleanProperty("enabled", "true 表示长按说话模式，false 表示单击说话模式", []() -> bool {
            auto board = static_cast<CqjtC3WifiBoard*>(&Board::GetInstance());
