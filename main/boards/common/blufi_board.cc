...
std::string BlufiBoard::GetBoardType() { return "blufi"; }
...
void BlufiBoard::EndNetwork() {}

bool BlufiBoard::IsConnected() { return true; }

Http* BlufiBoard::CreateHttp() { return new EspHttp(); }
